...
#pragma warning restore CA1021 //CA1021: "Avoid `out` parameters"
	...
	public static IReadOnlyList<T> ReadOnlyListOf<T>() => ArrayWrapper.Of<T>().AsReadOnlyList();
	public static IReadOnlyList<T> ReadOnlyListOf<T>( T element ) => ArrayWrapper.Of( element ).AsReadOnlyList();
	public static IReadOnlyList<T> ReadOnlyListOf<T>( T element1, T element2 ) => ArrayWrapper.Of( element1, element2 ).AsReadOnlyList();
	public static IReadOnlyList<T> ReadOnlyListOf<T>( T element1, T element2, T element3 ) => ArrayWrapper.Of( element1, element2, element3 ).AsReadOnlyList();
	public static IReadOnlyList<T> ReadOnlyListOf<T>( params T[] elements ) => ArrayWrapper.Of( elements ).AsReadOnlyList();
